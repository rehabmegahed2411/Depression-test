...
import 'package:test_proj/Test/ChangesInAppetite.dart';
    ...
    selectedGradientColor: LinearGradient(
        ...
        colors: [Color(0xFF8ABAC5), Colors.white],
            ...
            RadioListTile<String>(
              title: Text('I haven\'t lost much weight, if any, lately.'),
            ...
            RadioListTile<String>(
              title: Text('I have lost more than five pounds.'),
              groupValue: selectedOption,
              value: 'b',
              onChanged: (value) {
                setState(() {
            ...
            RadioListTile<String>(
              title: Text('I have lost more than ten pounds.'),
              groupValue: selectedOption,
              value: 'c',
              onChanged: (value) {
                setState(() {
            ...
            RadioListTile<String>(
              title: Text('I have lost more than fifteen pounds.'),
              groupValue: selectedOption,
              value: 'd',
              onChanged: (value) {
                setState(() {
