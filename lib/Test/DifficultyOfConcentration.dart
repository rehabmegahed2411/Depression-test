...
class DifficultyOfConcentration extends StatefulWidget {
  @override
  _DifficultyOfConcentration createState() => _DifficultyOfConcentration();
}

class _DifficultyOfConcentration extends State<DifficultyOfConcentration> {
    ...
    selectedGradientColor: LinearGradient(
        ...
        colors: [Color(0xFF8ABAC5), Colors.white],
            ...
            Container(
              ...
              child: Text(
                '15. Difficulty of concentration',
                style: TextStyle(
                  fontSize: 15.0,
            ...
            RadioListTile<String>(
              title: Text('I can work about as well as before.'),
            ...
            RadioListTile<String>(
              title: Text('I have to push myself very hard to do anything .'),
              groupValue: selectedOption,
              value: 'c',
              onChanged: (value) {
                setState(() {
            ...
            RadioListTile<String>(
              title: Text('I can\'t do any work at all.'),
              groupValue: selectedOption,
              value: 'd',
              onChanged: (value) {
                setState(() {
