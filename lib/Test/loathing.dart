...
class Loathing extends StatefulWidget {
  @override
  _Loathing createState() => _Loathing();
}

class _Loathing extends State<Loathing> {
    ...
    selectedGradientColor: LinearGradient(
        ...
        colors: [Color(0xFF8ABAC5), Colors.white],
            ...
            RadioListTile<String>(
              title: Text('I  don\'t feel disappointed in my self .'),
            ...
            RadioListTile<String>(
              title: Text('I am disappointed in my self.'),
              groupValue: selectedOption,
              value: 'b',
              onChanged: (value) {
                setState(() {
            ...
            RadioListTile<String>(
              title: Text('I am disguested with my self .'),
              groupValue: selectedOption,
              value: 'c',
              onChanged: (value) {
                setState(() {
